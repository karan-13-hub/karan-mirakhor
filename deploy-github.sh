...
if ! git remote get-url origin > /dev/null 2>&1; then
    ...
    echo "   git remote add origin https://github.com/karan-13-hub/karan-mirakhor.git"
    echo ""
    echo "📝 To create a new repository on GitHub:"
    echo "   1. Go to https://github.com/new"
    echo "   2. Name it 'karan-mirakhor' for GitHub Pages"
    echo "   3. Make sure it's under your personal account (not organization)"
    echo "   4. Enable Pages in Settings > Pages > Source: Deploy from a branch"
    echo ""
...
echo "   https://karan-13-hub.github.io/karan-mirakhor/"
echo ""
echo "📋 Next steps:"
